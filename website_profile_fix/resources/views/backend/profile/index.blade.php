...
@section('title')
    <title>Dashboard - Profile User</title>
@endsection
          ...
          <div class="col-xl-4">
            ...
            <div class="card">
              <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                ...
                <img src="{{ URL::to('backend/assets/img/', $user->image) }}" alt="Profile" class="rounded-circle">
                <h2>{{$user->name}}</h2>
                <h3>{{$user->role}}</h3>
                ...
                <div class="tab-content pt-2">
                  ...
                  <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                    ...
                    @method('PATCH')
                      <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <div class="pt-2">
                                ...
                                <!--<input type="file" id="profile-image" hidden name="image">-->
                      ...
                      <input name="role" type="hidden" class="form-control" id="Job" value="{{$user->role}}">
                  ...
                  <div class="tab-pane fade pt-3" id="profile-change-password">
                    ...
                    <form method="POST" action="{{ route('password.update',$user->id) }}" oninput='confirmPassword.setCustomValidity(confirmPassword.value != password.value ? "Passwords do not match." : "")'>
                    @csrf
                    @method('PUT')
