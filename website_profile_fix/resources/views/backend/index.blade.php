          ...
          <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="{{ asset('backend/assets/img/slides-1.jpg') }}" width="1000" height="600" class="d-block w-100" alt="...">
              ...
              <div class="carousel-item">
                <img src="{{ asset('backend/assets/img/slides-2.jpg') }}" width="1000" height="600" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
              ...
              <div class="carousel-item">
                <img src="{{ asset('backend/assets/img/slides-3.jpg') }}" width="1000" height="600" class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
        ...
        <div class="row">
          ...
          <div class="col-xxl-4 col-md-6">
            <div class="card info-card revenue-card">
              ...
              <div class="card-body">
                <h5 class="card-title">Sarpras <span>| This Month</span></h5>
          ...
          <div class="col-xxl-4 col-xl-12">
            ...
            <div class="card info-card customers-card">
              ...
              <div class="card-body">
                <h5 class="card-title">News <span>| This Year</span></h5>
          ...
          <div class="col-xxl-4 col-md-6">
            <div class="card info-card sales-card">
              ...
              <div class="card-body">
                <h5 class="card-title">Course <span>| Today</span></h5>
